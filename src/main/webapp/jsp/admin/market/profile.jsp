...
<table>
	<tr>
		<td>Profiles on market</td>
	</tr>
</table>

<form action="<c:url value="/admin/market/profile.htm?market=${param.market}"/>" method="post">

<table>
	<c:forEach items="${marketProfileForm.profiles}" var="profile">
		<c:set var="found" value="0" />
		<c:forEach items="${marketProfileForm.profileId2}" var="profileId2">
